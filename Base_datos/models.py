...
class Locutor_nacional(models.Model):
    ...
    DNI = models.IntegerField(validators=[MaxValueValidator(9)], null='True', blank=True)
    ...
    habilitación = models.IntegerField(validators=[MaxValueValidator(9)], null='True', blank=True)
    año_expediente = models.IntegerField(validators=[MaxValueValidator(4)], null='True', blank=True)
    número_expediente = models.IntegerField(validators=[MaxValueValidator(9)], null='True', blank=True)
    año_disposición = models.IntegerField(validators=[MaxValueValidator(4)], null='True', blank=True)
    número_disposición = models.IntegerField(validators=[MaxValueValidator(9)], null='True', blank=True)
