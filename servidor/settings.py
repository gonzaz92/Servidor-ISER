...
SECRET_KEY = 'django-insecure-&$a=u6ai7#+d@&6t51l3s1b5rvuriz^3-9$qkmueo51p$-)g9i'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'Base_datos.context_processor.buscar_persona',
                'Base_datos.context_processor.buscar_exp',
                'Base_datos.context_processor.buscar_correo',
                'Base_datos.context_processor.buscar_act',
            ],
        },
    },
]
